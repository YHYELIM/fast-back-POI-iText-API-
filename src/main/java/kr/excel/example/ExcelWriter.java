...
public class ExcelWriter {
    public static void main(String[] args) {
        ...
        List<kr.excel.array.Member> members = new ArrayList<>();
        while (true) {
            ...
            kr.excel.array.Member member = new  kr.excel.array.Member(name, age, birthdate, phone, address, isMarried);
            members.add(member);
        }
        scanner.close();
        ...
        try {
            ...
            for (int i = 0; i < members.size(); i++) {
                kr.excel.array.Member member = members.get(i);
            ...
            workbook.close();
            outputStream.close(); // 파일 스트림 닫기
            System.out.println("엑셀 파일이 저장되었습니다. 파일명: " + filename);
        } catch (IOException e) {
